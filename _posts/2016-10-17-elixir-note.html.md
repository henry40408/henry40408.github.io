...
* [Developing Elm using Gulp with Elixir / Phoenix](https://simonh1000.github.io/2016/10/elm-phoenix-gulp/) 在 Elixir 裡使用 Elm。不過也不用這麼麻煩啦，Hex 上有一個 [eml](https://github.com/zambal/eml)，雖然是 Elixir 的實作，寫起來跟 Elm 非常像，喜歡 Elm 的開發者可以參考看看。

...
![Probot Logo，是不是很可愛呢？真的很可愛呢](0*sNAZgn2pnGIlUFRy.png)
...
1.  我點下綠色按鈕之後
2.  就 *自動* 把 PR 指定給送出 PR 的人
3.  我此時就可以離開 GitHub 了

以上提到有關 *自動* 的步驟，就是可以交給 Probot 代勞的工作。不過在繼續解釋 Probot 之前，要先介紹一個稱為 _GitHub Webhook_ 的概念。
